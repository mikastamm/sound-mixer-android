...
public class VCCryptography {
    ...
    public static void generateRSAKeyPair(boolean ignoreGenerated){
        ...
        try {
            if(ignoreGenerated || (prefs.getString(MainActivity.RSAPrivateKey_PrefKey, null) == null && prefs.getString(MainActivity.RSAPublicKey_PrefKey, null) == null))
            {
                ...
                editor.putString(MainActivity.RSAPrivateKey_PrefKey, privateKeyBase64);
                editor.putString(MainActivity.RSAPublicKey_PrefKey, publicKeyBase64);
                editor.apply();
                ...
                String privateKeyBase64 = prefs.getString(MainActivity.RSAPrivateKey_PrefKey, null);
                String publicKeyBase64 = prefs.getString(MainActivity.RSAPublicKey_PrefKey, null);
