...
public class AudioSessionChangeMessageSenderRunnable implements Runnable {
    public static String messageTag = "EDIT";

    private ServerConnection connection;
    private AudioSession changedSession;

    public AudioSessionChangeMessageSenderRunnable(AudioSession changedSession, ServerConnection connection) {
